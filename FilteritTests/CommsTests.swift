...
class CommsTests: XCTestCase {
    ...
    func testIntegration_ListPhotos() {
        ...
        response.subscribe(onNext: { (images) in
            ...
            XCTAssertEqual(images.first!.thumbUrl, "https://MeteC.github.io/Filterit/server/img/thumbnail/backlit-dawn-fog-2088210.jpg")
            XCTAssertEqual(images.first!.url, "https://MeteC.github.io/Filterit/server/img/fullsize/backlit-dawn-fog-2088210.jpg")
